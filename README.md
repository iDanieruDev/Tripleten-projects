...
| [¿Qué factores influyen en el precio de vehiculo?](03precios_vehiculos) | Análisis exploratorio de datos (EDA) | Somos analistas de una empresa de anuncios. Cientos de anuncios gratuitos de vehículos se publican en el sitio web cada día. Necesitamos estudiar los datos recopilados durante los últimos años y determinar qué factores influyen en el precio de un vehículo.  | *pandas, matplotlib.pyplot, numpy* |
